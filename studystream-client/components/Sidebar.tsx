...
import { AppleCardsCarouselDemo } from "@/components/Todo";  // Assuming this is where your carousel lives
...
export function SidebarDemo() {
  ...
  return (
    <div
      className={cn(
        "flex flex-col md:flex-row bg-black w-full h-screen overflow-hidden"
      )}
    >
      ...
      {/* Replace dummy dashboard with the carousel component */}
      <div className="flex-1">
        <AppleCardsCarouselDemo />  {/* Integrating your carousel */}
      </div>
    </div>
  );
}
